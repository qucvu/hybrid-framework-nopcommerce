...
public class CompareProductPageUI {
	...
	public static final String NAME_LABEL_AT_COMPARISION_TABLE_BY_PRODUCT_NAME = "xpath=//tr[@class='product-name']//a[text()='%s']/parent::td/preceding-sibling::td/label[text()='Name']";
